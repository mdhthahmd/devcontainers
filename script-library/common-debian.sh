...
if [ "$INSTALL_ZSH" = "true" ] && [ ! -d "/root/.oh-my-zsh" ]; then 
    ...
    echo "ZSH_THEME=\"powerlevel9k/powerlevel9k\"" >> root/.zshrc
    # Install powerlevel9k theme
    sh -c "$(git clone https://github.com/Powerlevel9k/powerlevel9k.git /root/.oh-my-zsh/custom/themes/powerlevel9k)"
    # and set it to default     # set color support
    # sed -i -e "s/robbyrussell/powerlevel9k\/powerlevel9k/g" -e '1iexport TERM="xterm-256color"'  /root/.zshrc
